...
<div class="mb-5 flex justify-center">
	<div class="card bg-base-100 shadow-xl">
		<div class="card-body items-center text-center">
			<h2 class="card-title justify-center">Contacto</h2>
			<p>Lun-Sab de 9:00 AM a 6:00 PM</p>
			...
			<p>Playa del Carmen, fraccionamiento FRONTEMARE.</p>
		</div>
		<figure>
