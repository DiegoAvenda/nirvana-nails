<script>
	...
	function getWeeklyDates(startDate = new Date(), daysToShow = 6) {
...
<section class="relative bg-stone-50 py-24">
	<div class="mx-auto w-full max-w-7xl overflow-x-auto px-6 lg:px-8">
		<div class="mb-5 flex flex-col items-center justify-between max-md:gap-3 md:flex-row">
			<div class="flex items-center gap-4">
				...
				<h6 class="text-xl font-semibold leading-8 text-gray-900">Today, January 2024</h6>
			</div>
			<div class="flex items-center gap-px rounded-lg bg-gray-100 p-1">
				<button
					class="rounded-lg px-5 py-2.5 text-sm font-medium text-gray-500 transition-all duration-300 hover:bg-white hover:text-indigo-600"
					>Day</button
				>
				<button
					class="rounded-lg bg-white px-5 py-2.5 text-sm font-medium text-indigo-600 transition-all duration-300 hover:bg-white hover:text-indigo-600"
					>Week</button
				>
				<button
					class="rounded-lg px-5 py-2.5 text-sm font-medium text-gray-500 transition-all duration-300 hover:bg-white hover:text-indigo-600"
			...
			<button
				class="flex items-center gap-2 rounded-xl bg-indigo-600 py-2.5 pl-5 pr-7 text-base font-semibold text-white transition-all duration-300 hover:bg-indigo-700"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="20"
		...
		<div class=" relative">
			<div class="sticky left-0 top-0 grid w-full grid-cols-7 border-t border-gray-200">
				<div class="flex items-center justify-center p-3.5 text-sm font-medium text-gray-900"></div>

				{#each weeklyDates as date}
					<div class="flex items-center justify-center p-3.5 text-sm font-medium text-gray-900">
						{date}
					</div>
				{/each}
			</div>
			<div class="hidden w-full grid-cols-7 overflow-x-auto sm:grid">
				<div
					class="flex h-32 items-end border-r border-t border-gray-200 p-0.5 transition-all hover:bg-stone-100 md:p-3.5 lg:h-28"
				>
					<span class="text-xs font-semibold text-gray-400">07:00 am</span>
				</div>

				{#each data.result as day}
					<div
						class="h-32 border-r border-t border-gray-200 p-0.5 transition-all hover:bg-stone-100 md:p-3.5 lg:h-28"
					>
						{#each day.slots as appointment}
							{#if !appointment.isAvailable}
								<div class="rounded border-l-2 border-purple-600 bg-purple-50 p-1.5">
									<p class="mb-px text-xs font-normal text-gray-900">Ocupado</p>
								</div>
							{/if}
						{/each}
					</div>
				...
				<div
					class="flex h-32 items-end border-r border-t border-gray-200 p-0.5 transition-all hover:bg-stone-100 md:p-3.5 lg:h-28"
				>
					<div class="rounded border-l-2 border-blue-600 bg-blue-50 p-1.5">
						<p class="mb-px text-xs font-normal text-gray-900">Project Task Review</p>
						<p class="text-xs font-semibold text-blue-600">08:00 - 08:25</p>
					</div>
				</div>
				<div
					class="h-32 border-t border-gray-200 p-0.5 transition-all hover:bg-stone-100 md:p-3.5 lg:h-28"
				></div>
				...
				<div
					class="h-32 border-r border-t border-gray-200 p-0.5 transition-all hover:bg-stone-100 md:p-3.5 lg:h-28"
				>
					<div class="rounded border-l-2 border-yellow-600 bg-yellow-50 p-1.5">
						<p class="mb-px text-xs font-normal text-gray-900">Breakfast with Dhruv Patel</p>
				...
				<div
					class="h-32 border-r border-t border-gray-200 p-0.5 transition-all hover:bg-stone-100 md:p-3.5 lg:h-28"
				>
					<div class="rounded border-l-2 border-green-600 bg-green-50 p-1.5">
						<p class="mb-px text-xs font-normal text-gray-900">Dancing Zumba class</p>
				...
				>
					<div class="rounded border-l-2 border-purple-600 bg-purple-50 p-1.5">
						<p class="mb-px text-xs font-normal text-gray-900">Doctor’s Appointment for Mother</p>
				...
				>
					<div class="rounded border-l-2 border-blue-600 bg-blue-50 p-1.5">
						<p class="mb-px text-xs font-normal text-gray-900">Daily Standup Meeting</p>
				...
				>
					<div class="rounded border-l-2 border-yellow-600 bg-yellow-50 p-1.5">
						<p class="mb-px text-xs font-normal text-gray-900">School Friend’s Birthday Party</p>
				...
				>
					<div class="rounded border-l-2 border-blue-600 bg-blue-50 p-1.5">
						<p class="mb-px text-xs font-normal text-gray-900">Meeting with Project Manager</p>
			...
			<div class="flex w-full items-center border-t border-gray-200 sm:hidden">
				<div class="flex flex-col">
					<div
						class="flex h-20 w-20 items-end border-b border-r border-gray-200 p-2 text-xs font-semibold text-gray-400"
					>
						07:00 am
					</div>
					<div
				...
				<div class="grid w-full grid-cols-1">
					<div class="h-20 w-full border-b border-gray-200 p-1.5">
						<div class="h-full w-full rounded border-l-2 border-purple-600 bg-purple-50 p-1.5">
							<p class="mb-px text-xs font-normal text-gray-900">Pickup the grandmother</p>
							<p class="text-xs font-semibold text-purple-600">06:00 - 07:30</p>
						</div>
					</div>
					<div class="h-20 w-full border-b border-gray-200 p-1.5"></div>
					<div class="h-20 w-full border-b border-gray-200 p-1.5"></div>
					<div class="h-20 w-full border-b border-gray-200 p-1.5"></div>
					<div class="h-20 w-full border-b border-gray-200 p-1.5"></div>
					<div class="h-20 w-full border-b border-gray-200 p-1.5">
						<div class="h-full w-full rounded border-l-2 border-blue-600 bg-blue-50 p-1.5">
							<p class="mb-px text-xs font-normal text-gray-900">Meeting with Project Manager</p>
							<p class="text-xs font-semibold text-blue-600">11:00 - 12:30</p>
						</div>
					</div>
